...
- Overhauled a key module, an in-house grid system, and led this long-term project - a React micro-frontend - that is served in AWS and read by the client as a UMD converted via an in-house package to provide a better UX with more performant and modern code
